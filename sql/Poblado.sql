...
insert into intention (user_id, state, content, date_of_Creation, title)
	values (9, 'En espera de revisión', 'Hay un salon en el bloque G, que en las maÃ±anas siempre le entra todo el sol del dÃ­a y enceguece a la hora de poner atenciÃ³n a clase, afecta la visibilidad y no se puede ver nada de lo que esta escrito en el tablero', TO_DATE('05/11/2018', 'DD/MM/YYYY'), 'Mejora de Salon');
insert into intention (user_id, state, content, date_of_Creation, title)
	values (5, 'En revisión', 'Sería genial tener una piscina para los estudiantes y que esa pueda haber un equipo de natación en la escuela, asÃ­ mismo para poder desestresarse de la carga de trabajos', TO_DATE('31/10/2018', 'DD/MM/YYYY'), 'Construir Piscina');

/*Comentario*/
insert into comentario (content, user_id, intention_id)
	values('Buena idea compaÃ±ero!, es un largo recorrido para nosotros los ciclistas', 11, 1);
insert into comentario (content, user_id, intention_id)
	values('Genial! Ahorramos mÃ¡s tiempo', 12, 1);
insert into comentario (content, user_id, intention_id)
	values('Por fin un internet decente', 10, 5);
insert into comentario (content, user_id, intention_id)
	values('Esto si merece la pena, siempre estÃ¡n llenas esas salas', 3, 3);
